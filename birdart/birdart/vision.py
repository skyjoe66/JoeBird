...
def verify_cutout(path: str, scientific: str, common: str) -> bool | None:
    ...
    prompt = (
        ...
        "- COUNT THE LEGS. Both legs and both feet must be visible and correctly "
        "attached to the body, each foot joined to its leg. One leg, a leg with no "
        "foot, a foot floating free, or two legs fused into one stalk: answer "
        "false. Image models get this wrong often, and it is the first thing a "
        "viewer notices.\n"
